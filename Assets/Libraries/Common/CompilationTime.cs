...
namespace Morpeh.Utils.Editor {
    ...
    public class CompilationTime {
        private const string ASSEMBLY_RELOAD_EVENTS_EDITOR_PREF          = "ASSEMBLY_RELOAD_EVENTS_TIME";
        private const string ASSEMBLY_COMPILATION_EVENTS_EDITOR_PREF     = "ASSEMBLY_COMPILATION_EVENTS";
        private const string ASSEMBLY_TOTAL_COMPILATION_TIME_EDITOR_PREF = "ASSEMBLY_TOTAL_COMPILATION_TIME";
