...
namespace _Game.Data
{
    ...
    public partial class PlayerData : PersistentDataBase
    {
        ...
        [DataField(createPresentedCounterpart:true), JsonProperty] protected int _coins = 0;
        [DataField(createPresentedCounterpart:true), JsonProperty] protected int _totalExp = 0;
